...
//        book1.setContent("bbbbb");
        ...
        // because Book, DVD and CD all extend from Media and
        // override the toString() method of their own,
        // when the loop gets to each Media element in the array,
        // it will call the toString() method
        // of corresponding class of each object,
        // resulting in different outputs.
        // That's polymorphism :D
